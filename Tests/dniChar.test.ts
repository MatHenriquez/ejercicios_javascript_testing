...
describe('dniChar', () => {
  ...
  it('Debe devolver la letra correcta para un número de DNI de dos dígitos', () => {
    const dni = 12;
  ...
  it('Debe devolver la letra correcta para un número de DNI de un dígito', () => {
    const dni = 1;
    const expectedLetter = 'T';
    const actualLetter = dniChar(dni);
    expect(actualLetter).toBe(expectedLetter);
  ...
  it('Debe devolver una cadena vacía para un número de DNI no válido', () => {
